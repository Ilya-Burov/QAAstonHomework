...
public class MtsTests {
    ...
    @Test
    @Feature("Проверка названия блока")
    ...
    @Test
    @Feature("Проверка текста плейсхолдеров")
    ...
    @Test
    @Feature("Корректность заполнения формы")
